...
import { seedEvents } from '@/db/seed-data';
...
export async function POST(request) {
  try {
    ...
    const eventsSummary = seedEvents
    ...
    if (!apiKey) {
      const fallback = generateLocalSuggestions(trimmedQuery, seedEvents, location);
    ...
    try {
      ...
      suggestions = generateLocalSuggestions(trimmedQuery, seedEvents, location);
    }
